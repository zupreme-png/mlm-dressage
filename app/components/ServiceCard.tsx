...
export function ServiceCard({ service }: { service: Service }) {
  return (
    <article className="flex h-full flex-col rounded-2xl border border-sand bg-white/70 p-8 transition-shadow hover:shadow-lg">
      <h3 className="font-serif text-2xl font-semibold text-bark">{service.title}</h3>
